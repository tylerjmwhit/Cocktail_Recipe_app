...
public class RecipeSearchByNameAsyncTask extends AsyncTask<String, Void, List<RecipeModel>>
{
...
//      a List of RecipeModel (List<RecipeModel>) that represents all the results for the ingredient
    ...
    protected List<RecipeModel> doInBackground(String... params)
    {
        ...
        String responseJson = TheCocktailDBApi.searchRecipesByName(searchTerm);
